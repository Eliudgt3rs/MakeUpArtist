...
const BookingPage = () => {
  ...
  const whatsappLink = `https://wa.me/254790632614?text=Hello%20Barbie%2C%20I%20would%20like%20to%20book%20a%20${encodeURIComponent(
    ...
    formData.time
  )}.%20My%20name%20is%20${encodeURIComponent(
    formData.name
  ...
  const handleEmailBooking = (e) => {
    ...
    const mailtoLink = `mailto:makeupbybarbie01@gmail.com?subject=${encodeURIComponent(
      subject
  ...
  return (
    <div className="py-9 bg-pink-50">
      <div className="container mx-auto px-3">
        <h2 className="text-3xl font-semibold text-center mb-4">
          Book an Appointment
        </h2>
        <p className="text-center text-stone-600 mb-6">
          Fill out the form below and choose whether to send your booking
          request via WhatsApp or Email. I am excited to help you look your
          best!
        </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
              ...
              >
                ...
                <option value="Natural Everyday Look">
