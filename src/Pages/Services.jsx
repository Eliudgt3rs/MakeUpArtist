...
const ServicesPage = () => {
  const services = [
    ...
    },
    {
      ...
      state: "House Call",
      description:
        "Don't wanna travel? Let me bring beauty and glam right at your doorstep. This package includes:",
      features: [
        "A luxury experience without leaving your home",
        "All necessary products and tools",
        "Touch-up kit for the day",
        "Perfect for busy schedules or special events",
      ],
    },
    {
      title: "Strip Lashes",
      ...
      state: "Strip Lashes",
      description:
        "Enhance your look with our premium strip lashes, perfect for any occasion. This service includes:",
      features: [
        "Application of high-quality strip lashes",
        "Customizable styles to suit your look",
        "Quick application (approximately 15 minutes)",
        "Perfect for adding volume and length",
      ],
    }
  ];
